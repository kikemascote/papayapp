...
public class TourActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean tourActivityVisited = sharedPreferences.getBoolean(StaticVarsUtils.TOUR_ACTIVITY_VISITED_KEY, false);//false for default
    ...
    private void setVisitToTrue() {
        ...
        editor.putBoolean(StaticVarsUtils.TOUR_ACTIVITY_VISITED_KEY, true);
        editor.commit();
    }
