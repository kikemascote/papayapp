        ...
        void bind(int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(SectionAdapter.FOOD_ID, foods[finalPosition].foodId);
                    ((Activity) context).startActivityForResult(intent, SectionAdapter.REQUEST_FOR_ACTIVITY_CODE);
                }
            });
        }
    }
