...
import co.hipstercoding.dev.papaya2.dialogs.AboutUsDialogFragment;
import co.hipstercoding.dev.papaya2.dialogs.AddFoodDialogFragment;
import co.hipstercoding.dev.papaya2.dialogs.AddSectionDialogFragment;
import co.hipstercoding.dev.papaya2.dialogs.ConfirmDeleteSectionDialogFragment;
import co.hipstercoding.dev.papaya2.dialogs.EditSectionDialogFragment;
import co.hipstercoding.dev.papaya2.dialogs.MoveFoodDialogFragment;
import co.hipstercoding.dev.papaya2.services.NotificationService;
import co.hipstercoding.dev.papaya2.services.WidgetService;
import co.hipstercoding.dev.papaya2.settings.SettingsActivity;
import co.hipstercoding.dev.papaya2.utils.DBUtils;
import co.hipstercoding.dev.papaya2.utils.NotifyInterfaceUtils;
import co.hipstercoding.dev.papaya2.utils.SectionUtils;
...
import co.hipstercoding.dev.papaya2.utils.StaticVarsUtils;
...
public class MainActivity extends AppCompatActivity
    ...
    private String urlAsString = "https://kikemascote.github.io/papayapp/#/about";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SectionAdapter.REQUEST_FOR_ACTIVITY_CODE) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_create_samples) {
            ...
            editor.putBoolean(StaticVarsUtils.TOUR_ACTIVITY_VISITED_KEY, false);
            editor.commit();
    ...
    public void checkIfSetAlarm() {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        Boolean notificationDeliveredToday = sharedPreferences.getBoolean(StaticVarsUtils.NOTIFICATION_DELIVERED_TODAY, false);//false for default

        if(notificationDeliveredToday) {
            //Log.d(TAG, "Notification already delivered today");
            int deliveredDay = sharedPreferences.getInt(StaticVarsUtils.NOTIFICATION_DELIVERED_DAY, 32);
            ...
            if(deliveredDay != day) {
                ...
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putBoolean(StaticVarsUtils.NOTIFICATION_DELIVERED_TODAY, true);
                editor.commit();
